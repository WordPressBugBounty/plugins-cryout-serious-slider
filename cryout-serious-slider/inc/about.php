						...
						<div id="seriousslider-tabs">
							...
							<div id="features">
								<ul>
									...
									<li><strong>Auto-generated Shortcodes and PHP integration.</strong> Use the auto generated shortcode to integrate slideshows with themes or other plugins. Copy-paste the auto generated PHP code to integrate with custom code.</li>
									<li><strong>Serious Slider Block.</strong> Insert slideshows in the content managed with the block editor</li>
									<li><strong>Serious Slider Widget.</strong> Display slideshows in sidebars via the classic Serious Slider widget</li>
									...
									<li><strong>8+ Appearance Styles.</strong> Choose from different appearance styles to make the navigation arrows, bullets, buttons and colors match your site.</li>
									...
									<li><strong>Individual options for each slider.</strong> All the customization options and set individually for every slider and locally for each block instance.</li>
							...
							<div id="customization">
								<ul>
									...
									<li>Choose from 8 slider styles, 7 transition effects and 5 caption text animations</li>
									<li>Customize block instances locally, separate from the general slider options</li>
							...
							<div id="functionality">
								<ul>
									...
									<li>Use WordPress' text editor to add HTML content to your slides</li>
